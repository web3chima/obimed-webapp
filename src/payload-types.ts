...
export interface Page {
  ...
  title: string;
  hero: {
    type: 'none' | 'brandSlider' | 'brandBanner' | 'highImpact' | 'mediumImpact' | 'lowImpact';
    richText?: {
      root: {
        type: string;
        children: {
    ...
    /**
     * Short messages that rotate under the main heading.
     */
    slides?:
      | {
          text: string;
    ...
    /**
     * Optional product image. A brand graphic is shown when empty.
     */
    brandMedia?: (number | null) | Media;
  };
  layout: (
    | CallToActionBlock
    | ContentBlock
...
export interface SolutionsBlock {
  ...
  items?:
    | {
        ...
        summary: string;
        /**
         * Revealed on hover (or tap on phones).
         */
        detail?: string | null;
        link: {
          type?: ('reference' | 'custom') | null;
...
export interface FAQBlock {
  ...
  items?:
    | {
        question: string;
        /**
         * Plain text. Also published to search engines as FAQ structured data.
         */
        answer: string;
        id?: string | null;
      }[]
...
export interface LogoStripBlock {
  heading?: string | null;
  /**
   * Shown when visitors hover the strip.
   */
  caption?: string | null;
  /**
   * Only list clients who have agreed to be named.
   */
  items?:
    | {
        name: string;
        /**
         * Optional. The name is shown as text when there is no logo.
         */
...
export interface ServicesBlock {
  ...
  items?:
    | {
        title: string;
        /**
         * Drops down on hover (or tap on phones).
         */
        description?: string | null;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "LegalDocumentBlock".
 */
export interface LegalDocumentBlock {
  lastUpdated?: string | null;
  version?: string | null;
  /**
   * Each H2 heading becomes an entry in the table of contents.
   */
  content: {
    root: {
      type: string;
...
export interface Product {
  ...
  title: string;
  /**
   * One or two sentences, shown on product cards.
   */
  ...
  description?: string | null;
  /**
   * Industries that use this product and what for.
   */
  applications?:
    | {
        industry: string;
  ...
  /**
   * Downloads such as COA or MSDS (PDF).
   */
  documents?:
    | {
        label: string;
    ...
    | null;
  category: 'excipient' | 'food-grade' | 'api';
...
export interface Job {
  ...
  isOpen?: boolean | null;
  /**
   * The role is hidden after this date.
   */
...
export interface PagesSelect<T extends boolean = true> {
  ...
  layout?:
    ...
    | {
        ...
        legalDocument?: T | LegalDocumentBlockSelect<T>;
      };
  meta?:
    | T
    | {
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "LegalDocumentBlock_select".
 */
export interface LegalDocumentBlockSelect<T extends boolean = true> {
  lastUpdated?: T;
  version?: T;
  content?: T;
  id?: T;
