...
const guardAccess = (
  ...
  for (const op of operations) {
    const fn = typeof access[op] === 'function' ? (access[op] as AccessFn) : payloadDefault
...
// customers edit content. Called from onInit so it also covers Payload's internal collections.
